...
"""
Credit: This code is copied from the following repository:
...
class MHSA_Block(nn.Module):
    def __init__(self, embed_dim, nhead, dim_feedforward, dropout, top_m):
        ...
        self.mlp = Mlp(in_features=embed_dim, hidden_features=dim_feedforward, act_layer=nn.GELU,
                       drop=0.1)  # Feedforward network
    def forward(self, x):
        """
